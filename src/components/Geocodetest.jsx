  ...
  return (
    <div className="min-h-fit flex flex-wrap justify-center gap-6 p-6 bg-gray-100">
      <div className="flex flex-col bg-white rounded p-4 w-full max-w-[500px] shadow-lg">
        ...
        <select
          className="font-bold text-xl bg-blue-300 py-2"
          value={city}
        ...
        <Link
          to="/forecast"
          className="text-white text-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mt-6 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
        >
          5 დღის პროგნოზი
        </Link>
      </div>
